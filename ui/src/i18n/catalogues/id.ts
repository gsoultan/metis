...
const id: Catalogue = {
  ...
  // Akses platform: siapa memegang peran apa. See the English catalogue.
  'access.tabAccounts': 'Akun',
  'access.tabRoles': 'Peran',
  'access.search': 'Cari orang',
  'access.searchPlaceholder': 'Cari berdasarkan nama, nama pengguna, atau email…',
  'access.columnPerson': 'Orang',
  'access.legendButton': 'Yang diizinkan {role}',
  'access.requiredFor': 'Diperlukan untuk',
  'access.requiredForNothing': 'Tidak ada tindakan yang memerlukan peran ini dengan sendirinya. Peran ini diperiksa sebagai bagian dari tindakan lain, seperti dijelaskan di atas.',
  'access.everythingElse': 'Tindakan yang tidak tercantum di sini tidak memerlukan peran, cukup masuk.',
  'access.legendUnavailable': 'Tidak dapat memuat apa yang diizinkan peran ini. Coba lagi nanti.',
  'access.holds': '{name} memegang {role}',
  'access.lacks': '{name} tidak memegang {role}',
  'access.editHint': 'Centang kotak untuk memberikan peran dan kosongkan untuk mencabutnya. Setiap perubahan langsung disimpan.',
  'access.readOnlyHint': 'Hanya administrator yang dapat mengubah siapa yang memegang suatu peran.',
  'access.cell': '{role} untuk {name}',
  'access.saving': 'Menyimpan {role} untuk {name}…',
  'access.savedTitle': 'Peran diubah',
  'access.granted': '{name} kini memegang {role}.',
  'access.revoked': '{name} tidak lagi memegang {role}.',
  'access.refusedTitle': 'Tidak dapat mengubah peran {name}',
  'access.confirmOwnAdmin':
    'Cabut peran Administrator Anda sendiri? Anda tidak akan dapat lagi mengelola akun, dan hanya administrator lain yang dapat memberikannya kembali.',
  'access.showing': '{count, plural, =1 {Menampilkan satu-satunya akun} other {Menampilkan semua # akun}}',
  'access.matching': '{count} dari {total} akun cocok',
  'access.noMatch': 'Tidak ada yang cocok dengan “{query}”.',
  'access.empty': 'Belum ada akun di organisasi ini.',
  'access.area.processes': 'Proses',
  'access.area.decisions': 'Keputusan',
  'access.area.connectors': 'Konektor',
  'access.area.webhooks': 'Webhook',
  'access.area.instances': 'Instansi yang berjalan',
  'access.area.people': 'Orang',
  'access.area.directories': 'Direktori',
  'access.area.projects': 'Proyek',
  'access.area.organizations': 'Organisasi',
  'access.area.groups': 'Grup',
  'access.area.accounts': 'Akun',
  'access.area.platform': 'Akun platform',
  'access.area.environments': 'Lingkungan',
  'access.area.other': 'Lainnya',
