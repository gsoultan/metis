...
const id: Catalogue = {
  ...
  'access.requiredForNothing': 'Tidak ada tindakan yang hanya dijaga oleh peran ini.',
  'access.everythingElse': 'Apa pun yang tidak tercantum terbuka bagi siapa saja yang sudah masuk.',
