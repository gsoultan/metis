...
const id: Catalogue = {
  ...
  // Tindakan yang memerlukan suatu peran, per nama metode. See the English catalogue.
  'access.action.CancelScheduledDefinition': 'Batalkan definisi terjadwal',
  'access.action.CreateDefinition': 'Buat definisi',
  'access.action.DeleteDefinition': 'Hapus definisi',
  'access.action.ExecuteScript': 'Jalankan skrip',
  'access.action.ImportDefinition': 'Impor definisi',
  'access.action.ListScriptTasks': 'Tampilkan daftar tugas skrip',
  'access.action.PromoteDefinition': 'Promosikan definisi',
  'access.action.ScheduleDefinition': 'Jadwalkan definisi',
  'access.action.Simulate': 'Simulasikan',
  'access.action.SimulateBatch': 'Simulasikan secara massal',
  'access.action.CreateDecision': 'Buat keputusan',
  'access.action.DeleteDecision': 'Hapus keputusan',
  'access.action.PromoteDecision': 'Promosikan keputusan',
  'access.action.UpdateDecision': 'Perbarui keputusan',
  'access.action.CreateConnector': 'Buat konektor',
  'access.action.CreateConnectorInstance': 'Buat instansi konektor',
  'access.action.DeleteConnector': 'Hapus konektor',
  'access.action.DeleteConnectorInstance': 'Hapus instansi konektor',
  'access.action.DeleteConnectorManifest': 'Hapus manifes konektor',
  'access.action.ExecuteConnector': 'Jalankan konektor',
  'access.action.InstallConnectorManifest': 'Pasang manifes konektor',
  'access.action.SetConnectorManifestEnabled': 'Aktifkan atau nonaktifkan manifes konektor',
  'access.action.TryConnectorStep': 'Coba langkah konektor',
  'access.action.UpdateConnector': 'Perbarui konektor',
  'access.action.UpdateConnectorInstance': 'Perbarui instansi konektor',
  'access.action.CloseLegacySignatures': 'Berhenti menerima tanda tangan lama',
  'access.action.CreateWebhook': 'Buat webhook',
  'access.action.DeleteWebhook': 'Hapus webhook',
  'access.action.SetWebhookEnabled': 'Aktifkan atau nonaktifkan webhook',
  ...
  'access.action.DeleteParticipantSource': 'Hapus sumber peserta',
  'access.action.ListParticipantSources': 'Tampilkan daftar sumber peserta',
  'access.action.SaveParticipantSource': 'Simpan sumber peserta',
  'access.action.SyncParticipantSource': 'Sinkronkan sumber peserta',
  'access.action.CreateProject': 'Buat proyek',
  'access.action.DeleteProject': 'Hapus proyek',
  'access.action.UpdateProject': 'Perbarui proyek',
  'access.action.CreateOrganization': 'Buat organisasi',
  'access.action.DeleteOrganization': 'Hapus organisasi',
  'access.action.UpdateOrganization': 'Perbarui organisasi',
  'access.action.AddMembership': 'Tambahkan keanggotaan',
  'access.action.CreateGroup': 'Buat grup',
  'access.action.DeleteGroup': 'Hapus grup',
  'access.action.RemoveMembership': 'Hapus keanggotaan',
  'access.action.UpdateGroup': 'Perbarui grup',
  ...
  'access.action.SetPlatformRoles': 'Tetapkan peran platform',
  'access.action.DeleteEnvironment': 'Hapus lingkungan',
  'access.action.ListEnvironments': 'Tampilkan daftar lingkungan',
  'access.action.SaveEnvironment': 'Simpan lingkungan',
  'access.action.TestEnvironmentConnection': 'Uji koneksi lingkungan',
