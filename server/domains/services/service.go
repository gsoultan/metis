...
func NewServiceFacade(
	...
	// The connector service registers the executors that ship. Overriding them
	// here is what let the application and every test that built a connector
	// service run different code.
