...
// source: table decision_releases

package decisionrelease
...
func (q Query) DecisionKeyEq(v string) Query       { return q.Where(DecisionKey.Eq(v)) }
func (q Query) DecisionKeyNotEq(v string) Query    { return q.Where(DecisionKey.NotEq(v)) }
func (q Query) DecisionKeyGt(v string) Query       { return q.Where(DecisionKey.Gt(v)) }
func (q Query) DecisionKeyGte(v string) Query      { return q.Where(DecisionKey.Gte(v)) }
func (q Query) DecisionKeyLt(v string) Query       { return q.Where(DecisionKey.Lt(v)) }
func (q Query) DecisionKeyLte(v string) Query      { return q.Where(DecisionKey.Lte(v)) }
func (q Query) DecisionKeyLike(v string) Query     { return q.Where(DecisionKey.Like(v)) }
func (q Query) DecisionKeyILike(v string) Query    { return q.Where(DecisionKey.ILike(v)) }
func (q Query) DecisionKeyIn(v ...string) Query    { return q.Where(DecisionKey.In(v...)) }
func (q Query) DecisionKeyNotIn(v ...string) Query { return q.Where(DecisionKey.NotIn(v...)) }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "project_id", "decision_key", "activate_at", "version", "deleted_at" FROM "decision_releases"`
const countPrefix = `SELECT count(*) FROM "decision_releases"`
const existsPrefix = `SELECT 1 FROM "decision_releases"`
...
var orderTable = [nCols][4]string{
	...
	{ // decision_key
		"\"decision_key\"",
		"\"decision_key\" DESC",
		"\"decision_key\" ASC NULLS FIRST",
		"\"decision_key\" DESC NULLS LAST",
	},
	{ // activate_at
		"\"activate_at\"",
		"\"activate_at\" DESC",
...
var fragTable = [8][27]runtime.Frag{
	...
	{ // decision_key
		...
		{A: "\"decision_key\" < $", B: ""},
		{A: "\"decision_key\" <= $", B: ""},
		{A: "\"decision_key\" LIKE $", B: ""},
		{A: "\"decision_key\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"decision_key\" = ANY($", B: ")"},
		{A: "\"decision_key\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
const insertSQL = `INSERT INTO "decision_releases" ("id", "created_at", "updated_at", "project_id", "decision_key", "activate_at", "version", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "project_id", "decision_key", "activate_at", "version", "deleted_at"`

const updatePrefix = `UPDATE "decision_releases" SET `
const deletePrefix = `DELETE FROM "decision_releases"`
...
const insPrefix = "INSERT INTO \"decision_releases\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"project_id\", \"decision_key\", \"activate_at\", \"version\", \"deleted_at\""
...
func (m *Mut) SetDecisionKey(v string) {
	m.row.DecisionKey = v
	m.dirty |= dDecisionKey
}
...
func (n *Ins) SetDecisionKey(v string) {
	n.row.DecisionKey = v
	n.set |= iDecisionKey
}
...
var conflictSpecs = []string{
	" ON CONFLICT (\"id\")",
	" ON CONFLICT (\"decision_key\", \"project_id\", \"activate_at\") WHERE deleted_at IS NULL",
}
...
// OnConflictDecisionKeyProjectIDActivateAt upserts on the unique index over (decision_key, project_id, activate_at, where deleted_at IS NULL).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictDecisionKeyProjectIDActivateAt() *Ins {
	n.conflict = 4
	return n
}
...
var assignFor = map[string]string{
	...
	"decision_key": "\"decision_key\" = EXCLUDED.\"decision_key\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 4:
			args = append(args, n.row.DecisionKey)
		case 5:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.DecisionKey)
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "decision_releases", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 2:
			args = append(args, m.row.DecisionKey)
		case 3:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "decision_releases" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "decision_releases" SET "deleted_at" = NULL`, []runtime.Section{
